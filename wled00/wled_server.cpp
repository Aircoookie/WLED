...
void initServer()
{
  ...
  if (!otaLock) {
    ...
    server.on("/update", HTTP_GET, [](AsyncWebServerRequest *request){
      if (correctPIN) request->send_P(200, "text/html", PAGE_update);
      else            request->send_P(200, "text/html", PAGE_settings_pin,  settingsProcessor);
    });
...
void serveSettings(AsyncWebServerRequest* request, bool post)
{
  ...
  switch (subPage)
  {
    ...
    case 252: request->send_P(200, "text/html", PAGE_settings_pin , settingsProcessor); break;
