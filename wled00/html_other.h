...
//server message
const char PAGE_msg0[] PROGMEM = R"=====(<!DOCTYPE html>
...
const char PAGE_welcome0[] PROGMEM = R"=====(<!DOCTYPE html>
<html><head><meta content='width=device-width' name='viewport'>
