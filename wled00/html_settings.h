...
type="checkbox" name="ES"><div><br><b>
DMX Fixture 1</b><br>Universe: <input name="DMX0U" type="number" min="0" 
max="63999" required><br>Start address: <input name="DMX0A" type="number" 
min="0" max="63999" required><br>Start LED: <input name="DMX0L" type="number" 
min="0" required><br>LED Count: <input name="DMX0C" type="number" min="0" 
required><br><br><b>DMX Fixture 2</b><br>Universe: <input name="DMX1U" 
type="number" min="0" max="63999" required><br>Start address: <input 
name="DMX1A" type="number" min="0" max="63999" required><br>Start LED: <input 
name="DMX1L" type="number" min="0" required><br>LED Count: <input name="DMX1C" 
type="number" min="0" required><br><br><b>DMX Fixture 3</b><br>Universe: <input 
name="DMX2U" type="number" min="0" max="63999" required><br>Start address: 
<input name="DMX2A" type="number" min="0" max="63999" required><br>Start LED: 
<input name="DMX2L" type="number" min="0" required><br>LED Count: <input 
name="DMX2C" type="number" min="0" required><br><br><b>DMX Fixture 4</b><br>
Universe: <input name="DMX3U" type="number" min="0" max="63999" required><br>
Start address: <input name="DMX3A" type="number" min="0" max="63999" required>
<br>Start LED: <input name="DMX3L" type="number" min="0" required><br>
LED Count: <input name="DMX3C" type="number" min="0" required><br><br><b>
DMX Fixture 5</b><br>Universe: <input name="DMX4U" type="number" min="0" 
max="63999" required><br>Start address: <input name="DMX4A" type="number" 
min="0" max="63999" required><br>Start LED: <input name="DMX4L" type="number" 
min="0" required><br>LED Count: <input name="DMX4C" type="number" min="0" 
required><br><br><b>DMX Fixture 6</b><br>Universe: <input name="DMX5U" 
type="number" min="0" max="63999" required><br>Start address: <input 
name="DMX5A" type="number" min="0" max="63999" required><br>Start LED: <input 
name="DMX5L" type="number" min="0" required><br>LED Count: <input name="DMX5C" 
type="number" min="0" required><br><br><b>DMX Fixture 7</b><br>Universe: <input 
name="DMX6U" type="number" min="0" max="63999" required><br>Start address: 
<input name="DMX6A" type="number" min="0" max="63999" required><br>Start LED: 
<input name="DMX6L" type="number" min="0" required><br>LED Count: <input 
name="DMX6C" type="number" min="0" required><br><br><b>DMX Fixture 8</b><br>
Universe: <input name="DMX7U" type="number" min="0" max="63999" required><br>
Start address: <input name="DMX7A" type="number" min="0" max="63999" required>
<br>Start LED: <input name="DMX7L" type="number" min="0" required><br>
LED Count: <input name="DMX7C" type="number" min="0" required><br><br><b>
DMX Fixture 9</b><br>Universe: <input name="DMX8U" type="number" min="0" 
max="63999" required><br>Start address: <input name="DMX8A" type="number" 
min="0" max="63999" required><br>Start LED: <input name="DMX8L" type="number" 
min="0" required><br>LED Count: <input name="DMX8C" type="number" min="0" 
required><br><br><b>DMX Fixture 10</b><br>Universe: <input name="DMX9U" 
type="number" min="0" max="63999" required><br>Start address: <input 
name="DMX9A" type="number" min="0" max="63999" required><br>Start LED: <input 
name="DMX9L" type="number" min="0" required><br>LED Count: <input name="DMX9C" 
type="number" min="0" required><br></div>DMX mode: <select name="DM"><option value="0">
