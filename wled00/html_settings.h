...
</a> version 1.0.1<br><br>(c) 2022 István Mészáros<br><i>Licensed under the <a 
...
</style></head><body onload="init(),GetV(),updateBrCtrl()"><form id="form_s" 
name="Sf" method="post"><button type="button" onclick="B()">Back</button><button
 type="submit">Save</button><hr><h2>LED Clock Settings</h2><h3>
Brightness Control</h3><input type="checkbox" name="autb" 
onchange="updateBrCtrl()"> Automatic brightness control:<br><div id="brctrl" 
class="il">Minimum brightness: <span id="minbv"></span><br><div 
class="sliderwrap il"><input id="minb" name="minb" max="254" min="1" 
type="range" oninput="adjustRange(!1),showBrCtrlVal()"><div 
