...
style="width:260px"><div id="btns"></div>IR pin: <input type="number" min="-1" 
max="40" name="IR" onchange="UI()"><select name="IT"><option value="0">
...
onchange="UI()"> invert <input type="checkbox" name="RM"><span 
...
<thead><tr><td></td><td>short<br>on-&gt;off</td><td>long<br>off-&gt;on</td><td>
double</td></tr></thead><tbody></tbody></table><h3>Time-controlled presets</h3>
