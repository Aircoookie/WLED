...
name="I0" type="number" min="0" max="255" required> . <input name="I1" 
...
name="AC" type="number" min="1" max="13" required><br>AP opens: <select 
name="AB"><option value="0">No connection after boot</option><option value="1">
Disconnected</option><option value="2">Always</option><option value="3">
...
var timeout,d=document,laprev=55,maxB=1,maxM=5e3,maxPB=4096,bquot=0;function H(){window.open("https://github.com/Aircoookie/WLED/wiki/Settings#led-settings")}function B(){window.open("/settings","_self")}function gId(e){return d.getElementById(e)}function off(e){d.getElementsByName(e)[0].value=-1}function showToast(e,n=!1){var a=gId("toast");a.innerHTML=e,a.className=n?"error":"show",clearTimeout(timeout),a.style.animation="none",timeout=setTimeout((function(){a.className=a.className.replace("show","")}),2900)}function bLimits(e,n,a){maxB=e,maxM=a,maxPB=n}function pinsOK(){var e=d.getElementsByTagName("input");for(i=0;i<e.length;i++){var n=e[i].name.substring(0,2);if(("L0"==n||"L1"==n||"L2"==n||"L3"==n||"L4"==n||"L5"==n||"L6"==n||"L7"==n||"RL"==n||"BT"==n||"IR"==n)&&""!=e[i].value&&"-1"!=e[i].value){if(d.um_p&&d.um_p.some(n=>n==parseInt(e[i].value,10)))return alert(`Sorry, pins ${JSON.stringify(d.um_p)} can't be used.`),e[i].value="",e[i].focus(),!1;if(e[i].value>5&&e[i].value<12)return alert("Sorry, pins 6-11 can not be used."),e[i].value="",e[i].focus(),!1;if("IR"!=n&&"BT"!=n&&e[i].value>33)return alert("Sorry, pins >33 are input only."),e[i].value="",e[i].focus(),!1;for(j=i+1;j<e.length;j++){var a=e[j].name.substring(0,2);if(("L0"==a||"L1"==a||"L2"==a||"L3"==a||"L4"==a||"L5"==a||"L6"==a||"L7"==a||"RL"==a||"BT"==a||"IR"==a)&&""!=e[j].value&&e[i].value==e[j].value)return alert(`Pin conflict between ${n}/${a}!`),e[j].value="",e[j].focus(),!1}}}return!0}function trySubmit(e){if(d.Sf.data.value="",e.preventDefault(),!pinsOK())return e.stopPropagation(),!1;if(bquot>100){var n="Too many LEDs for me to handle!";maxM<1e4&&(n+="\n\rConsider using an ESP32."),alert(n)}d.Sf.checkValidity()&&d.Sf.submit()}function S(){GetV(),setABL()}function enABL(){var e=gId("able").checked;d.Sf.LA.value=e?laprev:0,gId("abl").style.display=e?"inline":"none",gId("psu2").style.display=e?"inline":"none",d.Sf.LA.value>0&&setABL()}function enLA(){var e=d.Sf.LAsel.value;d.Sf.LA.value=e,gId("LAdis").style.display=50==e?"inline":"none",UI()}function setABL(){switch(gId("able").checked=!0,d.Sf.LAsel.value=50,parseInt(d.Sf.LA.value)){case 0:gId("able").checked=!1,enABL();break;case 30:d.Sf.LAsel.value=30;break;case 35:d.Sf.LAsel.value=35;break;case 55:d.Sf.LAsel.value=55;break;case 255:d.Sf.LAsel.value=255;break;default:gId("LAdis").style.display="inline"}gId("m1").innerHTML=maxM,d.getElementsByName("Sf")[0].addEventListener("submit",trySubmit),UI()}function getMem(e,n,a){return e<32?maxM<1e4&&3==a?e>29?20*n:15*n:maxM>=1e4?e>29?8*n:6*n:e>29?4*n:3*n:e>31&&e<48?5:44==e||45==e?4*n:3*n}function UI(e=!1){var n=!1,a=0;gId("ampwarning").style.display=d.Sf.MA.value>7200?"inline":"none",255==d.Sf.LA.value?laprev=12:d.Sf.LA.value>0&&(laprev=d.Sf.LA.value);var t=d.getElementsByTagName("select");for(f=0;f<t.length;f++)if("LT"==t[f].name.substring(0,2)){c=t[f].name.substring(2);var i=parseInt(t[f].value,10);gId("p0d"+c).innerHTML=i>49?"Data GPIO:":i>41?"GPIOs:":"GPIO:",gId("p1d"+c).innerHTML=i>49?"Clk GPIO:":"";var l=d.getElementsByName("L1"+c)[0];for(a+=getMem(i,d.getElementsByName("LC"+c)[0].value,d.getElementsByName("L0"+c)[0].value),v=1;v<5;v++){(l=d.getElementsByName("L"+v+c)[0])&&(i>49&&1==v||i>41&&i<50&&v+40<i?(l.style.display="inline",l.required=!0):(l.style.display="none",l.required=!1,l.value=""))}e&&(gId("ls"+c).value=c+1,i>31&&i<48&&(d.getElementsByName("LC"+c)[0].value=1)),n|=30==i||31==i||44==i||45==i,gId("dig"+c).style.display=i>31&&i<48?"none":"inline",gId("psd"+c).innerHTML=i>31&&i<48?"Index:":"Start:"}var o=d.querySelectorAll(".wc"),s=o.length;for(f=0;f<s;f++)o[f].style.display=n?"inline":"none";var u=d.getElementsByTagName("input"),r=0,p=0;for(f=0;f<u.length;f++){var m=u[f].name.substring(0,2);if("LC"!=m||"LC"===u[f].name){if("L0"==m||"L1"==m)d.getElementsByName("LC"+u[f].name.substring(2))[0].max=maxPB;if(("L0"==m||"L1"==m||"L2"==m||"L3"==m||"L4"==m||"L5"==m||"L6"==m||"L7"==m||"RL"==m||"BT"==m||"IR"==m)&&""!=u[f].value&&"-1"!=u[f].value){var v=[];if(d.um_p&&Array.isArray(d.um_p))for(k=0;k<d.um_p.length;k++)v.push(d.um_p[k]);for(j=0;j<u.length;j++)if(f!=j){var L=u[j].name.substring(0,2);"L0"!=L&&"L1"!=L&&"L2"!=L&&"L3"!=L&&"L4"!=L&&"L5"!=L&&"L6"!=L&&"L7"!=L&&"RL"!=L&&"BT"!=L&&"IR"!=L||""!=u[j].value&&"-1"!=u[j].value&&v.push(parseInt(u[j].value,10))}v.some(e=>e==parseInt(u[f].value,10))?u[f].style.color="red":u[f].style.color=parseInt(u[f].value,10)>33?"orange":"#fff"}}else{var c=u[f].name.substring(2),g=parseInt(u[f].value,10);gId("ls"+c).value=r,g&&(r+=g,g>p&&(p=g))}}if(gId("LC").readOnly&&(d.getElementsByName("LC")[0].value=r),d.activeElement==d.getElementsByName("LC")[0]){var f=d.getElementsByClassName("iST").length;1==f&&(d.getElementsByName("LC0")[0].value=d.getElementsByName("LC")[0].value)}gId("m0").innerHTML=a,bquot=a/maxM*100,gId("dbar").style.background=`linear-gradient(90deg, ${bquot>60?bquot>90?"red":"orange":"#ccc"} 0 ${bquot}%%, #444 ${bquot}%% 100%%)`,gId("ledwarning").style.display=r>maxPB||p>800||bquot>80?"inline":"none",gId("ledwarning").style.color=r>maxPB||p>maxPB||bquot>100?"red":"orange",gId("wreason").innerHTML=bquot>80?"80% of max. LED memory"+(bquot>100?` (<b>WARNING: Using over ${maxM}B!</b>)`:""):"800 LEDs per GPIO";var y=Math.ceil((100+r*laprev)/500)/2;y=y>5?Math.ceil(y):y;t="";var I=30==d.Sf.LAsel.value,b=255==d.Sf.LAsel.value;y<1.02&&!I&&!b?t="ESP 5V pin with 1A USB supply":(t+=I?"12V ":b?"WS2815 12V ":"5V ",t+=y,t+="A supply connected to LEDs");var B=Math.ceil((100+r*laprev)/1500)/2,S="(for most effects, ~";S+=B=B>5?Math.ceil(B):B,S+="A is enough)<br>",gId("psu").innerHTML=t,gId("psu2").innerHTML=b?"":S,gId("json").style.display=8==d.Sf.IT.value?"":"none"}function lastEnd(e){return e<1?0:(v=parseInt(d.getElementsByName("LS"+(e-1))[0].value)+parseInt(d.getElementsByName("LC"+(e-1))[0].value),isNaN(v)?0:v)}function addLEDs(e){if(e>1)return maxB=e,void(gId("+").style.display="inline");var n=d.getElementsByClassName("iST"),a=n.length;if(!(1==e&&a>=maxB||-1==e&&0==a)){var t=gId("mLC");if(1==e){var i=`<div class="iST">\n${a>0?'<hr style="width:260px">':""}\n${a+1}:\n<select name="LT${a}" onchange="UI(true)">\n<option value="22">WS281x</option>\n<option value="30">SK6812 RGBW</option>\n<option value="31">TM1814</option>\n<option value="24">400kHz</option>\n<option value="50">WS2801</option>\n<option value="51">APA102</option>\n<option value="52">LPD8806</option>\n<option value="53">P9813</option>\n<option value="41">PWM White</option>\n<option value="42">PWM WWCW</option>\n<option value="43">PWM RGB</option>\n<option value="44">PWM RGBW</option>\n<option value="45">PWM RGBWC</option>\n</select>&nbsp;\nColor Order:\n<select name="CO${a}">\n<option value="0">GRB</option>\n<option value="1">RGB</option>\n<option value="2">BRG</option>\n<option value="3">RBG</option>\n<option value="4">BGR</option>\n<option value="5">GBR</option>\n</select><br>\n<span id="p0d${a}">GPIO:</span><input type="number" name="L0${a}" min="0" max="33" required class="sml" onchange="UI()"/>\n<span id="p1d${a}"></span><input type="number" name="L1${a}" min="0" max="33" class="sml" onchange="UI()"/>\n<span id="p2d${a}"></span><input type="number" name="L2${a}" min="0" max="33" class="sml" onchange="UI()"/>\n<span id="p3d${a}"></span><input type="number" name="L3${a}" min="0" max="33" class="sml" onchange="UI()"/>\n<span id="p4d${a}"></span><input type="number" name="L4${a}" min="0" max="33" class="sml" onchange="UI()"/>\n<br>\n<span id="psd${a}">Start:</span> <input type="number" name="LS${a}" id="ls${a}" min="0" max="8191" value="${lastEnd(a)}" readonly required />&nbsp;\n<div id="dig${a}" style="display:inline">\nCount: <input type="number" name="LC${a}" min="0" max="${maxPB}" value="1" required oninput="UI()" /><br>\nReverse (rotated 180°): <input type="checkbox" name="CV${a}">\n&nbsp;Skip 1<sup>st</sup> LED: <input id="sl${a}" type="checkbox" name="SL${a}"><br>\n</div>\n</div>`;t.insertAdjacentHTML("beforeend",i)}-1==e&&(n[--a].remove(),--a),gId("+").style.display=a<maxB-1?"inline":"none",gId("-").style.display=a>0?"inline":"none",UI()}}function addBtn(e,n,a){var t=gId("btns").innerHTML,i="BT"+e;t+=`Button ${e} GPIO: <input type="number" min="-1" max="40" name="${i}" onchange="UI()" class="sml" value="${n}">`,t+=`<select name="${"BE"+e}">`,t+=`<option value="0" ${0==a?"selected":""}>Disabled</option>`,t+=`<option value="2" ${2==a?"selected":""}>Pushbutton</option>`,t+=`<option value="3" ${3==a?"selected":""}>Push inverted</option>`,t+=`<option value="4" ${4==a?"selected":""}>Switch</option>`,t+=`<option value="5" ${5==a?"selected":""}>PIR sensor</option>`,t+=`<option value="6" ${6==a?"selected":""}>Touch</option>`,t+=`<option value="7" ${7==a?"selected":""}>Analog</option>`,t+=`<option value="8" ${8==a?"selected":""}>Analog inverted</option>`,t+="</select>",t+=`<span style="cursor: pointer;" onclick="off('${i}')">&nbsp;&#215;</span><br>`,gId("btns").innerHTML=t}function uploadFile(e){var n=new XMLHttpRequest;n.addEventListener("load",(function(){showToast(this.responseText)})),n.addEventListener("error",(function(e){showToast(e.stack,!0)})),n.open("POST","/upload");var a=new FormData;return a.append("data",d.Sf.data.files[0],e),n.send(a),d.Sf.data.value="",!1}function GetV() {var d=document;
%CSS%%SCSS%<link href="/skin.css" 
rel="stylesheet"></head><body onload="S()"><form id="form_s" name="Sf" 
method="post"><div class="toprow"><div class="helpB"><button type="button" 
onclick="H()">?</button></div><button type="button" onclick="B()">Back</button>
<button type="submit">Save</button><hr></div><h2>LED &amp; Hardware setup</h2>
Total LED count: <input name="LC" id="LC" type="number" min="1" max="8192" 
oninput="UI()" required readonly="readonly"><br><i>
...
max="40" name="IR" onchange="UI()" class="sml"><select name="IT" 
...
onchange="UI()" class="sml"> invert <input type="checkbox" name="RM"><span 
...
onclick='uploadFile("/skin.css")'><br></div><div id="toast"></div><hr><button 
...
method="post"><div class="toprow"><div class="helpB"><button type="button" 
onclick="H()">?</button></div><button type="button" onclick="B()">Back</button>
<button type="submit">Save & Reboot</button><hr></div><h2>
