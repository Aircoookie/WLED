...
class="small" min="0" max="255" required> . <input name="I1" type="number" 
class="small" min="0" max="255" required> . <input name="I2" type="number" 
class="small" min="0" max="255" required> . <input name="I3" type="number" 
class="small" min="0" max="255" required><br>Static gateway:<br><input 
name="G0" type="number" class="small" min="0" max="255" required> . <input 
name="G1" type="number" class="small" min="0" max="255" required> . <input 
name="G2" type="number" class="small" min="0" max="255" required> . <input 
name="G3" type="number" class="small" min="0" max="255" required><br>
Static subnet mask:<br><input name="S0" type="number" class="small" min="0" 
max="255" required> . <input name="S1" type="number" class="small" min="0" 
max="255" required> . <input name="S2" type="number" class="small" min="0" 
max="255" required> . <input name="S3" type="number" class="small" min="0" 
...
name="AC" type="number" class="tiny" min="1" max="13" required><br>AP opens: 
...
name="MA" type="number" class="xmed" min="250" max="65000" oninput="UI()" 
...
class="small" min="0" max="100" name="TT" required><br>IR pin: <input 
type="number" class="tiny" min="-1" max="40" name="IR" onchange="UI()">&nbsp;
<select name="IT"><option value="0">Remote disabled</option><option value="1">
...
9-key red</option></select><span style="cursor:pointer" onclick='off("IR")'>
&nbsp;&#215;</span><br><a 
href="https://github.com/Aircoookie/WLED/wiki/Infrared-Control" target="_blank">
IR info</a><br>Relay pin: <input type="number" class="tiny" min="-1" max="33" 
...
type="number" class="small" min="0" max="255" required> (0-255)<br><br>
Apply preset <input name="BP" type="number" class="small" min="0" max="250" 
...
class="small" min="1" max="255" required> %<h3>Transitions</h3>Crossfade: <input
 type="checkbox" name="TF"><br>Transition Time: <input name="TD" type="number" 
class="xmed" min="0" max="65500"> ms<br>Enable Palette transitions: <input 
type="checkbox" name="PF"><h3>Timed light</h3>Default Duration: <input 
name="TL" type="number" class="small" min="1" max="255" required> min<br>
Default Target brightness: <input name="TB" type="number" class="small" min="0" 
