...
var timeout,d=document,laprev=55,maxB=1,maxM=5e3,maxPB=4096,bquot=0;function H(){window.open("https://github.com/Aircoookie/WLED/wiki/Settings#led-settings")}function B(){window.open("/settings","_self")}function gId(e){return d.getElementById(e)}function off(e){d.getElementsByName(e)[0].value=-1}function showToast(e,n=!1){var a=gId("toast");a.innerHTML=e,a.className=n?"error":"show",clearTimeout(timeout),a.style.animation="none",timeout=setTimeout((function(){a.className=a.className.replace("show","")}),2900)}function bLimits(e,n,a){maxB=e,maxM=a,maxPB=n}function pinsOK(){var e=d.getElementsByTagName("input");for(i=0;i<e.length;i++){var n=e[i].name.substring(0,2);if("L0"==n||"L1"==n||"L2"==n||"L3"==n){var a=e[i].name.substring(2),t=parseInt(d.getElementsByName("LT"+a)[0].value,10);if(2==t||3==t)continue}if(("L0"==n||"L1"==n||"L2"==n||"L3"==n||"L4"==n||"RL"==n||"BT"==n||"IR"==n)&&""!=e[i].value&&"-1"!=e[i].value){if(d.um_p&&d.um_p.some(n=>n==parseInt(e[i].value,10)))return alert(`Sorry, pins ${JSON.stringify(d.um_p)} can't be used.`),e[i].value="",e[i].focus(),!1;if(e[i].value>5&&e[i].value<12)return alert("Sorry, pins 6-11 can not be used."),e[i].value="",e[i].focus(),!1;if("IR"!=n&&"BT"!=n&&e[i].value>33)return alert("Sorry, pins >33 are input only."),e[i].value="",e[i].focus(),!1;for(j=i+1;j<e.length;j++){var s=e[j].name.substring(0,2);if("L0"==s||"L1"==s||"L2"==s||"L3"==s||"L4"==s||"RL"==s||"BT"==s||"IR"==s){if("L"===s.substring(0,1)){var l=e[j].name.substring(2),o=parseInt(d.getElementsByName("LT"+l)[0].value,10);if(2==o||3==o)continue}if(""!=e[j].value&&e[i].value==e[j].value)return alert(`Pin conflict between ${e[i].name}/${e[j].name}!`),e[j].value="",e[j].focus(),!1}}}}return!0}function trySubmit(e){if(d.Sf.data.value="",e.preventDefault(),!pinsOK())return e.stopPropagation(),!1;if(bquot>100){var n="Too many LEDs for me to handle!";maxM<1e4&&(n+="\n\rConsider using an ESP32."),alert(n)}d.Sf.checkValidity()&&d.Sf.submit()}function S(){GetV(),setABL()}function enABL(){var e=gId("able").checked;d.Sf.LA.value=e?laprev:0,gId("abl").style.display=e?"inline":"none",gId("psu2").style.display=e?"inline":"none",d.Sf.LA.value>0&&setABL()}function enLA(){var e=d.Sf.LAsel.value;d.Sf.LA.value=e,gId("LAdis").style.display=50==e?"inline":"none",UI()}function setABL(){switch(gId("able").checked=!0,d.Sf.LAsel.value=50,parseInt(d.Sf.LA.value)){case 0:gId("able").checked=!1,enABL();break;case 30:d.Sf.LAsel.value=30;break;case 35:d.Sf.LAsel.value=35;break;case 55:d.Sf.LAsel.value=55;break;case 255:d.Sf.LAsel.value=255;break;default:gId("LAdis").style.display="inline"}gId("m1").innerHTML=maxM,d.getElementsByName("Sf")[0].addEventListener("submit",trySubmit),UI()}function getMem(e,n,a){return 2==e||3==e?n*(e+1):e<32?maxM<1e4&&3==a?e>29?20*n:15*n:maxM>=1e4?e>29?8*n:6*n:e>29?4*n:3*n:e>31&&e<48?5:44==e||45==e?4*n:3*n}function UI(e=!1){var n=!1,a=0;gId("ampwarning").style.display=d.Sf.MA.value>7200?"inline":"none",255==d.Sf.LA.value?laprev=12:d.Sf.LA.value>0&&(laprev=d.Sf.LA.value);var t=d.getElementsByTagName("select");for(I=0;I<t.length;I++)if("LT"==t[I].name.substring(0,2)){var i=t[I].name.substring(2),s=parseInt(t[I].value,10);gId("p0d"+i).innerHTML=2==s||3==s?"IP address:":s>49?"Data GPIO:":s>41?"GPIOs:":"GPIO:",gId("p1d"+i).innerHTML=s>49?"Clk GPIO:":"";var l=d.getElementsByName("L1"+i)[0];for(a+=getMem(s,d.getElementsByName("LC"+i)[0].value,d.getElementsByName("L0"+i)[0].value),c=1;c<5;c++){(l=d.getElementsByName("L"+c+i)[0])&&((2==s||3==s)&&c<4||s>49&&1==c||s>41&&s<50&&c+40<s?(l.style.display="inline",l.required=!0):(l.style.display="none",l.required=!1,l.value=""))}e&&(gId("ls"+i).value=i+1,s>31&&s<48&&(d.getElementsByName("LC"+i)[0].value=1)),n|=30==s||31==s||s>40&&s<46&&43!=s,gId("co"+i).style.display=2==s||3==s||41==s||42==s?"none":"inline",gId("dig"+i+"c").style.display=s>40&&s<48?"none":"inline",gId("dig"+i+"r").style.display=2==s||3==s?"none":"inline",gId("dig"+i+"s").style.display=2==s||3==s||s>40&&s<48?"none":"inline",gId("rev"+i).innerHTML=s>40&&s<48?"Inverted":"Reverse (rotated 180°)",gId("psd"+i).innerHTML=s>40&&s<48?"Index:":"Start:"}var o=d.querySelectorAll(".wc"),u=o.length;for(I=0;I<u;I++)o[I].style.display=n?"inline":"none";var r=d.getElementsByTagName("input"),p=0,m=0;for(I=0;I<r.length;I++){var v=r[I].name.substring(0,2);i=r[I].name.substring(2);if("LC"!=v||"LC"===r[I].name){if("L0"==v||"L1"==v)d.getElementsByName("LC"+i)[0].max=maxPB;if("L0"==v||"L1"==v||"L2"==v||"L3"==v){if(2==(s=parseInt(d.getElementsByName("LT"+i)[0].value,10))||3==s){r[I].max=255,r[I].min=0;continue}r[I].max=33,r[I].min=-1}if(("L0"==v||"L1"==v||"L2"==v||"L3"==v||"L4"==v||"RL"==v||"BT"==v||"IR"==v)&&""!=r[I].value&&"-1"!=r[I].value){var c=[];if(d.um_p&&Array.isArray(d.um_p))for(k=0;k<d.um_p.length;k++)c.push(d.um_p[k]);for(j=0;j<r.length;j++)if(I!=j){var g=r[j].name.substring(0,2);if("L0"==g||"L1"==g||"L2"==g||"L3"==g||"L4"==g||"RL"==g||"BT"==g||"IR"==g){if("L"===g.substring(0,1)){var L=r[j].name.substring(2),f=parseInt(d.getElementsByName("LT"+L)[0].value,10);if(2==f||3==f)continue}""!=r[j].value&&"-1"!=r[j].value&&c.push(parseInt(r[j].value,10))}}c.some(e=>e==parseInt(r[I].value,10))?r[I].style.color="red":r[I].style.color=parseInt(r[I].value,10)>33?"orange":"#fff"}}else{var y=parseInt(r[I].value,10);gId("ls"+i).value=p,y&&(p+=y,y>m&&(m=y))}}if(gId("LC").readOnly&&(d.getElementsByName("LC")[0].value=p),d.activeElement==d.getElementsByName("LC")[0]){var I=d.getElementsByClassName("iST").length;1==I&&(d.getElementsByName("LC0")[0].value=d.getElementsByName("LC")[0].value)}gId("m0").innerHTML=a,bquot=a/maxM*100,gId("dbar").style.background=`linear-gradient(90deg, ${bquot>60?bquot>90?"red":"orange":"#ccc"} 0 ${bquot}%%, #444 ${bquot}%% 100%%)`,gId("ledwarning").style.display=p>maxPB||m>800||bquot>80?"inline":"none",gId("ledwarning").style.color=p>maxPB||m>maxPB||bquot>100?"red":"orange",gId("wreason").innerHTML=bquot>80?"80% of max. LED memory"+(bquot>100?` (<b>WARNING: Using over ${maxM}B!</b>)`:""):"800 LEDs per GPIO";var b=Math.ceil((100+p*laprev)/500)/2;b=b>5?Math.ceil(b):b;t="";var B=30==d.Sf.LAsel.value,S=255==d.Sf.LAsel.value;b<1.02&&!B&&!S?t="ESP 5V pin with 1A USB supply":(t+=B?"12V ":S?"WS2815 12V ":"5V ",t+=b,t+="A supply connected to LEDs");var h=Math.ceil((100+p*laprev)/1500)/2,$="(for most effects, ~";$+=h=h>5?Math.ceil(h):h,$+="A is enough)<br>",gId("psu").innerHTML=t,gId("psu2").innerHTML=S?"":$,gId("json").style.display=8==d.Sf.IT.value?"":"none"}function lastEnd(e){if(e<1)return 0;v=parseInt(d.getElementsByName("LS"+(e-1))[0].value)+parseInt(d.getElementsByName("LC"+(e-1))[0].value);var n=parseInt(d.getElementsByName("LT"+(e-1))[0].value);return n>31&&n<48&&(v=1),isNaN(v)?0:v}function addLEDs(e){if(e>1)return maxB=e,void(gId("+").style.display="inline");var n=d.getElementsByClassName("iST"),a=n.length;if(!(1==e&&a>=maxB||-1==e&&0==a)){var t=gId("mLC");if(1==e){var i=`<div class="iST">\n<hr style="width:260px">\n${a+1}:\n<select name="LT${a}" onchange="UI(true)">\n<option value="22" selected>WS281x</option>\n<option value="30">SK6812 RGBW</option>\n<option value="31">TM1814</option>\n<option value="24">400kHz</option>\n<option value="50">WS2801</option>\n<option value="51">APA102</option>\n<option value="52">LPD8806</option>\n<option value="53">P9813</option>\n<option value="41">PWM White</option>\n<option value="42">PWM WWCW</option>\n<option value="43">PWM RGB</option>\n<option value="44">PWM RGBW</option>\n<option value="45">PWM RGBWC</option>\n<option value="2">Virtual RGB</option>\n<option value="3">Virtual RGBW</option>\n</select>&nbsp;\n<div id="co${a}" style="display:inline">Color Order:\n<select name="CO${a}">\n<option value="0">GRB</option>\n<option value="1">RGB</option>\n<option value="2">BRG</option>\n<option value="3">RBG</option>\n<option value="4">BGR</option>\n<option value="5">GBR</option>\n</select></div>\n<br>\n<span id="p0d${a}">GPIO:</span><input type="number" name="L0${a}" min="0" max="33" required class="s" onchange="UI()"/>\n<span id="p1d${a}"></span><input type="number" name="L1${a}" min="0" max="33" class="s" onchange="UI()"/>\n<span id="p2d${a}"></span><input type="number" name="L2${a}" min="0" max="33" class="s" onchange="UI()"/>\n<span id="p3d${a}"></span><input type="number" name="L3${a}" min="0" max="33" class="s" onchange="UI()"/>\n<span id="p4d${a}"></span><input type="number" name="L4${a}" min="0" max="33" class="s" onchange="UI()"/>\n<br>\n<span id="psd${a}">Start:</span> <input type="number" name="LS${a}" id="ls${a}" class="l" min="0" max="8191" value="${lastEnd(a)}" disabled readonly required />&nbsp;\n<div id="dig${a}c" style="display:inline">Count: <input type="number" name="LC${a}" class="l" min="0" max="${maxPB}" value="1" required oninput="UI()" /></div>\n<br>\n<div id="dig${a}r" style="display:inline"><span id="rev${a}">Reversed</span>: <input type="checkbox" name="CV${a}"></div>&nbsp;\n<div id="dig${a}s" style="display:inline">Skip 1<sup>st</sup> LED: <input id="sl${a}" type="checkbox" name="SL${a}"></div>\n<br>\n</div>`;t.insertAdjacentHTML("beforeend",i)}-1==e&&(n[--a].remove(),--a),gId("+").style.display=a<maxB-1?"inline":"none",gId("-").style.display=a>0?"inline":"none",UI()}}function addBtn(e,n,a){var t=gId("btns").innerHTML,i="BT"+e;t+=`Button ${e} GPIO: <input type="number" min="-1" max="40" name="${i}" onchange="UI()" class="s" value="${n}">`,t+=`<select name="${"BE"+e}">`,t+=`<option value="0" ${0==a?"selected":""}>Disabled</option>`,t+=`<option value="2" ${2==a?"selected":""}>Pushbutton</option>`,t+=`<option value="3" ${3==a?"selected":""}>Push inverted</option>`,t+=`<option value="4" ${4==a?"selected":""}>Switch</option>`,t+=`<option value="5" ${5==a?"selected":""}>PIR sensor</option>`,t+=`<option value="6" ${6==a?"selected":""}>Touch</option>`,t+=`<option value="7" ${7==a?"selected":""}>Analog</option>`,t+=`<option value="8" ${8==a?"selected":""}>Analog inverted</option>`,t+="</select>",t+=`<span style="cursor: pointer;" onclick="off('${i}')">&nbsp;&#215;</span><br>`,gId("btns").innerHTML=t}function uploadFile(e){var n=new XMLHttpRequest;n.addEventListener("load",(function(){showToast(this.responseText,this.status>=400)})),n.addEventListener("error",(function(e){showToast(e.stack,!0)})),n.open("POST","/upload");var a=new FormData;return a.append("data",d.Sf.data.files[0],e),n.send(a),d.Sf.data.value="",!1}function GetV() {var d=document;
