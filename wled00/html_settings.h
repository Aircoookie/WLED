...
var timeout,d=document,laprev=55,maxB=1,maxM=5e3,maxPB=4096,bquot=0;function H(){window.open("https://github.com/Aircoookie/WLED/wiki/Settings#led-settings")}function B(){window.open("/settings","_self")}function gId(e){return d.getElementById(e)}function off(e){d.getElementsByName(e)[0].value=-1}function showToast(e,n=!1){var t=gId("toast");t.innerHTML=e,t.className=n?"error":"show",clearTimeout(timeout),t.style.animation="none",timeout=setTimeout((function(){t.className=t.className.replace("show","")}),2900)}function bLimits(e,n,t){maxB=e,maxM=t,maxPB=n}function pinsOK(){var e=d.getElementsByTagName("input");for(i=0;i<e.length;i++){var n=e[i].name.substring(0,2);if("L0"==n||"L1"==n||"L2"==n||"L3"==n){var t=e[i].name.substring(2);if(parseInt(d.getElementsByName("LT"+t)[0].value,10)<16)continue}if(("L0"==n||"L1"==n||"L2"==n||"L3"==n||"L4"==n||"RL"==n||"BT"==n||"IR"==n)&&""!=e[i].value&&"-1"!=e[i].value){if(d.um_p&&d.um_p.some(n=>n==parseInt(e[i].value,10)))return alert(`Sorry, pins ${JSON.stringify(d.um_p)} can't be used.`),e[i].value="",e[i].focus(),!1;if(e[i].value>5&&e[i].value<12)return alert("Sorry, pins 6-11 can not be used."),e[i].value="",e[i].focus(),!1;if("IR"!=n&&"BT"!=n&&e[i].value>33)return alert("Sorry, pins >33 are input only."),e[i].value="",e[i].focus(),!1;for(j=i+1;j<e.length;j++){var a=e[j].name.substring(0,2);if("L0"==a||"L1"==a||"L2"==a||"L3"==a||"L4"==a||"RL"==a||"BT"==a||"IR"==a){if("L"===a.substring(0,1)){var s=e[j].name.substring(2);if(parseInt(d.getElementsByName("LT"+s)[0].value,10)<16)continue}if(""!=e[j].value&&e[i].value==e[j].value)return alert(`Pin conflict between ${e[i].name}/${e[j].name}!`),e[j].value="",e[j].focus(),!1}}}}return!0}function trySubmit(e){if(d.Sf.data.value="",e.preventDefault(),!pinsOK())return e.stopPropagation(),!1;if(bquot>100){var n="Too many LEDs for me to handle!";maxM<1e4&&(n+="\n\rConsider using an ESP32."),alert(n)}d.Sf.checkValidity()&&d.Sf.submit()}function S(){GetV(),setABL()}function enABL(){var e=gId("able").checked;d.Sf.LA.value=e?laprev:0,gId("abl").style.display=e?"inline":"none",gId("psu2").style.display=e?"inline":"none",d.Sf.LA.value>0&&setABL()}function enLA(){var e=d.Sf.LAsel.value;d.Sf.LA.value=e,gId("LAdis").style.display=50==e?"inline":"none",UI()}function setABL(){switch(gId("able").checked=!0,d.Sf.LAsel.value=50,parseInt(d.Sf.LA.value)){case 0:gId("able").checked=!1,enABL();break;case 30:d.Sf.LAsel.value=30;break;case 35:d.Sf.LAsel.value=35;break;case 55:d.Sf.LAsel.value=55;break;case 255:d.Sf.LAsel.value=255;break;default:gId("LAdis").style.display="inline"}gId("m1").innerHTML=maxM,d.getElementsByName("Sf")[0].addEventListener("submit",trySubmit),UI()}function getMem(e,n,t){return e>=10&&e<=12?6*n:e>15&&e<32?maxM<1e4&&3==t?e>29?20*n:15*n:maxM>=1e4?e>29?8*n:6*n:e>29?4*n:3*n:e>31&&e<48?5:44==e||45==e?4*n:3*n}function UI(e=!1){var n=!1,t=0;gId("ampwarning").style.display=d.Sf.MA.value>7200?"inline":"none",255==d.Sf.LA.value?laprev=12:d.Sf.LA.value>0&&(laprev=d.Sf.LA.value);var a=d.getElementsByTagName("select");for(y=0;y<a.length;y++)if("LT"==a[y].name.substring(0,2)){var i=a[y].name.substring(2),s=parseInt(a[y].value,10);gId("p0d"+i).innerHTML=s>=10&&s<=15?"IP address:":s>49?"Data GPIO:":s>41?"GPIOs:":"GPIO:",gId("p1d"+i).innerHTML=s>49?"Clk GPIO:":"";var l=d.getElementsByName("L1"+i)[0];for(t+=getMem(s,d.getElementsByName("LC"+i)[0].value,d.getElementsByName("L0"+i)[0].value),c=1;c<5;c++){(l=d.getElementsByName("L"+c+i)[0])&&(s>=10&&s<=15&&c<4||s>49&&1==c||s>41&&s<50&&c+40<s?(l.style.display="inline",l.required=!0):(l.style.display="none",l.required=!1,l.value=""))}e&&(gId("ls"+i).value=i+1,s>31&&s<48&&(d.getElementsByName("LC"+i)[0].value=1)),n|=30==s||31==s||s>40&&s<46&&43!=s,gId("co"+i).style.display=s<16||41==s||42==s?"none":"inline",gId("dig"+i+"c").style.display=s>40&&s<48?"none":"inline",gId("dig"+i+"r").style.display=s<16?"none":"inline",gId("dig"+i+"s").style.display=s<16||s>40&&s<48?"none":"inline",gId("rev"+i).innerHTML=s>40&&s<48?"Inverted":"Reverse (rotated 180°)",gId("psd"+i).innerHTML=s>40&&s<48?"Index:":"Start:"}var o=d.querySelectorAll(".wc"),u=o.length;for(y=0;y<u;y++)o[y].style.display=n?"inline":"none";var r=d.getElementsByTagName("input"),p=0,m=0;for(y=0;y<r.length;y++){var v=r[y].name.substring(0,2);i=r[y].name.substring(2);if("LC"!=v||"LC"===r[y].name){if("L0"==v||"L1"==v)d.getElementsByName("LC"+i)[0].max=maxPB;if("L0"==v||"L1"==v||"L2"==v||"L3"==v){if((s=parseInt(d.getElementsByName("LT"+i)[0].value,10))<16){r[y].max=255,r[y].min=0;continue}r[y].max=33,r[y].min=-1}if(("L0"==v||"L1"==v||"L2"==v||"L3"==v||"L4"==v||"RL"==v||"BT"==v||"IR"==v)&&""!=r[y].value&&"-1"!=r[y].value){var c=[];if(d.um_p&&Array.isArray(d.um_p))for(k=0;k<d.um_p.length;k++)c.push(d.um_p[k]);for(j=0;j<r.length;j++)if(y!=j){var g=r[j].name.substring(0,2);if("L0"==g||"L1"==g||"L2"==g||"L3"==g||"L4"==g||"RL"==g||"BT"==g||"IR"==g){if("L"===g.substring(0,1)){var L=r[j].name.substring(2);if(parseInt(d.getElementsByName("LT"+L)[0].value,10)<16)continue}""!=r[j].value&&"-1"!=r[j].value&&c.push(parseInt(r[j].value,10))}}c.some(e=>e==parseInt(r[y].value,10))?r[y].style.color="red":r[y].style.color=parseInt(r[y].value,10)>33?"orange":"#fff"}}else{var f=parseInt(r[y].value,10);gId("ls"+i).value=p,f&&(p+=f,f>m&&(m=f))}}if(gId("LC").readOnly&&(d.getElementsByName("LC")[0].value=p),d.activeElement==d.getElementsByName("LC")[0]){var y=d.getElementsByClassName("iST").length;1==y&&(d.getElementsByName("LC0")[0].value=d.getElementsByName("LC")[0].value)}gId("m0").innerHTML=t,bquot=t/maxM*100,gId("dbar").style.background=`linear-gradient(90deg, ${bquot>60?bquot>90?"red":"orange":"#ccc"} 0 ${bquot}%%, #444 ${bquot}%% 100%%)`,gId("ledwarning").style.display=p>maxPB||m>800||bquot>80?"inline":"none",gId("ledwarning").style.color=p>maxPB||m>maxPB||bquot>100?"red":"orange",gId("wreason").innerHTML=bquot>80?"80% of max. LED memory"+(bquot>100?` (<b>WARNING: Using over ${maxM}B!</b>)`:""):"800 LEDs per GPIO";var I=Math.ceil((100+p*laprev)/500)/2;I=I>5?Math.ceil(I):I;a="";var b=30==d.Sf.LAsel.value,B=255==d.Sf.LAsel.value;I<1.02&&!b&&!B?a="ESP 5V pin with 1A USB supply":(a+=b?"12V ":B?"WS2815 12V ":"5V ",a+=I,a+="A supply connected to LEDs");var S=Math.ceil((100+p*laprev)/1500)/2,h="(for most effects, ~";h+=S=S>5?Math.ceil(S):S,h+="A is enough)<br>",gId("psu").innerHTML=a,gId("psu2").innerHTML=B?"":h,gId("json").style.display=8==d.Sf.IT.value?"":"none"}function lastEnd(e){if(e<1)return 0;v=parseInt(d.getElementsByName("LS"+(e-1))[0].value)+parseInt(d.getElementsByName("LC"+(e-1))[0].value);var n=parseInt(d.getElementsByName("LT"+(e-1))[0].value);return n>31&&n<48&&(v=1),isNaN(v)?0:v}function addLEDs(e){if(e>1)return maxB=e,void(gId("+").style.display="inline");var n=d.getElementsByClassName("iST"),t=n.length;if(!(1==e&&t>=maxB||-1==e&&0==t)){var a=gId("mLC");if(1==e){var i=`<div class="iST">\n<hr style="width:260px">\n${t+1}:\n<select name="LT${t}" onchange="UI(true)">\n<option value="22" selected>WS281x</option>\n<option value="30">SK6812 RGBW</option>\n<option value="31">TM1814</option>\n<option value="24">400kHz</option>\n<option value="50">WS2801</option>\n<option value="51">APA102</option>\n<option value="52">LPD8806</option>\n<option value="53">P9813</option>\n<option value="41">PWM White</option>\n<option value="42">PWM WWCW</option>\n<option value="43">PWM RGB</option>\n<option value="44">PWM RGBW</option>\n<option value="45">PWM RGBWC</option>\n<option value="10">DDP RGB (network)</option>\n\x3c!--option value="11">E1.31 RGB (network)</option--\x3e\n\x3c!--option value="12">ArtNet RGB (network)</option--\x3e\n</select>&nbsp;\n<div id="co${t}" style="display:inline">Color Order:\n<select name="CO${t}">\n<option value="0">GRB</option>\n<option value="1">RGB</option>\n<option value="2">BRG</option>\n<option value="3">RBG</option>\n<option value="4">BGR</option>\n<option value="5">GBR</option>\n</select></div>\n<br>\n<span id="p0d${t}">GPIO:</span><input type="number" name="L0${t}" min="0" max="33" required class="s" onchange="UI()"/>\n<span id="p1d${t}"></span><input type="number" name="L1${t}" min="0" max="33" class="s" onchange="UI()"/>\n<span id="p2d${t}"></span><input type="number" name="L2${t}" min="0" max="33" class="s" onchange="UI()"/>\n<span id="p3d${t}"></span><input type="number" name="L3${t}" min="0" max="33" class="s" onchange="UI()"/>\n<span id="p4d${t}"></span><input type="number" name="L4${t}" min="0" max="33" class="s" onchange="UI()"/>\n<br>\n<span id="psd${t}">Start:</span> <input type="number" name="LS${t}" id="ls${t}" class="l" min="0" max="8191" value="${lastEnd(t)}" disabled readonly required />&nbsp;\n<div id="dig${t}c" style="display:inline">Count: <input type="number" name="LC${t}" class="l" min="0" max="${maxPB}" value="1" required oninput="UI()" /></div>\n<br>\n<div id="dig${t}r" style="display:inline"><span id="rev${t}">Reversed</span>: <input type="checkbox" name="CV${t}"></div>&nbsp;\n<div id="dig${t}s" style="display:inline">Skip 1<sup>st</sup> LED: <input id="sl${t}" type="checkbox" name="SL${t}"></div>\n<br>\n</div>`;a.insertAdjacentHTML("beforeend",i)}-1==e&&(n[--t].remove(),--t),gId("+").style.display=t<maxB-1?"inline":"none",gId("-").style.display=t>0?"inline":"none",UI()}}function addBtn(e,n,t){var a=gId("btns").innerHTML,i="BT"+e;a+=`Button ${e} GPIO: <input type="number" min="-1" max="40" name="${i}" onchange="UI()" class="s" value="${n}">`,a+=`<select name="${"BE"+e}">`,a+=`<option value="0" ${0==t?"selected":""}>Disabled</option>`,a+=`<option value="2" ${2==t?"selected":""}>Pushbutton</option>`,a+=`<option value="3" ${3==t?"selected":""}>Push inverted</option>`,a+=`<option value="4" ${4==t?"selected":""}>Switch</option>`,a+=`<option value="5" ${5==t?"selected":""}>PIR sensor</option>`,a+=`<option value="6" ${6==t?"selected":""}>Touch</option>`,a+=`<option value="7" ${7==t?"selected":""}>Analog</option>`,a+=`<option value="8" ${8==t?"selected":""}>Analog inverted</option>`,a+="</select>",a+=`<span style="cursor: pointer;" onclick="off('${i}')">&nbsp;&#215;</span><br>`,gId("btns").innerHTML=a}function uploadFile(e){var n=new XMLHttpRequest;n.addEventListener("load",(function(){showToast(this.responseText,this.status>=400)})),n.addEventListener("error",(function(e){showToast(e.stack,!0)})),n.open("POST","/upload");var t=new FormData;return t.append("data",d.Sf.data.files[0],e),n.send(t),d.Sf.data.value="",!1}function GetV() {var d=document;
...
LED &amp; Hardware setup</h2>Total LED count: <input name="LC" id="LC" 
type="number" min="1" max="8192" oninput="UI()" disabled="disabled" required 
readonly="readonly"><br><i>Recommended power supply for brightest white:</i><br>
...
<button type="button" id="+" onclick="addLEDs(1)">+</button> <button 
type="button" id="-" onclick="addLEDs(-1)">-</button><br>LED Memory Usage: <span
 id="m0">0</span> / <span id="m1">?</span> B<br><div id="dbar" 
...
style="width:260px">Create a segment for each output: <input type="checkbox" 
name="MS"><br><hr style="width:260px"><div id="btns"></div>Touch threshold: 
<input type="number" min="0" max="100" name="TT" required><br>IR GPIO: <input 
type="number" min="-1" max="40" name="IR" onchange="UI()" class="s"><select 
...
IR info</a><br>Relay GPIO: <input type="number" min="-1" max="33" name="RL" 
onchange="UI()" class="s"> invert <input type="checkbox" name="RM"><span 
