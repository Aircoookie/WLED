...
var d=document,laprev=55,maxB=1,maxM=5e3,maxPB=4096,bquot=0;function H(){window.open("https://github.com/Aircoookie/WLED/wiki/Settings#led-settings")}function B(){window.open("/settings","_self")}function bLimits(e,n,t){maxB=e,maxM=t,maxPB=n}function trySubmit(){var e=d.getElementsByTagName("input");for(i=0;i<e.length;i++){var n=e[i].name.substring(0,2);if(("L0"==n||"L1"==n||"L2"==n||"L3"==n||"L4"==n||"RL"==n||"BT"==n||"IR"==n||"AX"==n)&&""!=e[i].value&&"-1"!=e[i].value){if(d.um_p&&d.um_p.some(n=>n==parseInt(e[i].value,10)))return alert("Usermod/reserved pin conflict!"),void e[i].focus();for(j=i+1;j<e.length;j++){var t=e[j].name.substring(0,2);if(("L0"==t||"L1"==t||"L2"==t||"L3"==t||"L4"==t||"RL"==t||"BT"==t||"IR"==t||"AX"==t)&&""!=e[j].value&&e[i].value==e[j].value)return alert(`Pin conflict between ${n}/${t}!`),void e[j].focus()}}}if(bquot>100){var a="Too many LEDs for me to handle!";return maxM<1e4&&(a+="\n\rConsider using an ESP32."),void alert(a)}d.Sf.reportValidity()&&d.Sf.submit()}function S(){GetV(),setABL()}function enABL(){var e=d.getElementById("able").checked;d.Sf.LA.value=e?laprev:0,d.getElementById("abl").style.display=e?"inline":"none",d.getElementById("psu2").style.display=e?"inline":"none",d.Sf.LA.value>0&&setABL()}function enLA(){var e=d.Sf.LAsel.value;d.Sf.LA.value=e,d.getElementById("LAdis").style.display=50==e?"inline":"none",UI()}function setABL(){switch(d.getElementById("able").checked=!0,d.Sf.LAsel.value=50,parseInt(d.Sf.LA.value)){case 0:d.getElementById("able").checked=!1,enABL();break;case 30:d.Sf.LAsel.value=30;break;case 35:d.Sf.LAsel.value=35;break;case 55:d.Sf.LAsel.value=55;break;case 255:d.Sf.LAsel.value=255;break;default:d.getElementById("LAdis").style.display="inline"}var e=d.getElementsByName("RL")[0];"-1"==e.value?e.readOnly=!0:d.getElementById("cRL").checked=!0;var n=d.getElementsByName("BT")[0];"-1"==n.value?n.readOnly=!0:d.getElementById("cBT").checked=!0;var t=d.getElementsByName("IR")[0];"-1"==t.value?t.readOnly=!0:d.getElementById("cIR").checked=!0;var a=d.getElementsByName("AX")[0];"-1"==a.value?a.readOnly=!0:d.getElementById("cAX").checked=!0,d.getElementById("m1").innerHTML=maxM,UI()}function getMem(e,n,t){return e<32?maxM<1e4&&3==t?e>29?20*n:15*n:maxM>=1e4?e>29?8*n:6*n:e>29?4*n:3*n:e>31&&e<48?5:44==e||45==e?4*n:3*n}function UI(e=!1){var n=!1,t=0;d.getElementById("ampwarning").style.display=d.Sf.MA.value>7200?"inline":"none",255==d.Sf.LA.value?laprev=12:d.Sf.LA.value>0&&(laprev=d.Sf.LA.value);var a=d.getElementsByTagName("select");for(B=0;B<a.length;B++)if("LT"==a[B].name.substring(0,2)){g=a[B].name.substring(2);var l=parseInt(a[B].value,10);d.getElementById("p0d"+g).innerHTML=l>49?"Data:":l>41?"Pins:":"Pin:",d.getElementById("p1d"+g).innerHTML=l>49?"Clk:":"";var i=d.getElementsByName("L1"+g)[0];for(t+=getMem(l,d.getElementsByName("LC"+g)[0].value,d.getElementsByName("L0"+g)[0].value),p=1;p<5;p++){(i=d.getElementsByName("L"+p+g)[0])&&(l>49&&1==p||l>41&&l<50&&p+40<l?(i.style.display="inline",i.required=!0):(i.style.display="none",i.required=!1,i.value=""))}d.getElementById("ls"+g).readOnly=!(l>31&&l<48),d.getElementById("LC").readOnly=!(l>31&&l<48),e&&(d.getElementById("ew"+g).checked=30==l||31==l||44==l||45==l,d.getElementById("ls"+g).value=g+1),d.getElementById("ew"+g).onclick=l>31&&l<48?function(){return!1}:function(){},n|=d.getElementById("ew"+g).checked,d.getElementById("dig"+g).style.display=l>31&&l<48?"none":"inline",d.getElementById("psd"+g).innerHTML=l>31&&l<48?"Index:":"Start:"}var o=d.querySelectorAll(".wc"),s=o.length;for(B=0;B<s;B++)o[B].style.display=n?"inline":"none";var m=d.getElementsByTagName("input"),r=0,u=0;for(B=0;B<m.length;B++){var y=m[B].name.substring(0,2);if("LC"!=y||"LC"===m[B].name){if("L0"==y||"L1"==y)d.getElementsByName("LC"+m[B].name.substring(2))[0].max=maxPB;if(("L0"==y||"L1"==y||"L2"==y||"L3"==y||"L4"==y||"RL"==y||"BT"==y||"IR"==y||"AX"==y)&&""!=m[B].value&&"-1"!=m[B].value){if(d.um_p&&d.um_p.some(e=>e==parseInt(m[B].value,10))){alert("Usermod/reserved pin conflict!"),m[B].focus();continue}for(j=0;j<m.length;j++)if(B!=j){var v=m[j].name.substring(0,2);if(("L0"==v||"L1"==v||"L2"==v||"L3"==v||"L4"==v||"RL"==v||"BT"==v||"IR"==v||"AX"==v)&&""!=m[j].value&&m[B].value==m[j].value){alert(`Pin conflict between ${y}/${v}!`),m[j].value="",m[j].focus();break}}}}else{var g=m[B].name.substring(2),c=parseInt(m[B].value,10);d.getElementById("ls"+g).readOnly&&(d.getElementById("ls"+g).value=r),c&&(r+=c,c>u&&(u=c))}}if(d.getElementById("LC").readOnly&&(d.getElementsByName("LC")[0].value=r),d.activeElement==d.getElementsByName("LC")[0]){var B=d.getElementsByClassName("iST").length;1==B&&(d.getElementsByName("LC0")[0].value=d.getElementsByName("LC")[0].value)}d.getElementById("m0").innerHTML=t,bquot=t/maxM*100,d.getElementById("dbar").style.background=`linear-gradient(90deg, ${bquot>60?bquot>90?"red":"orange":"#ccc"} 0 ${bquot}%%, #444 ${bquot}%% 100%%)`,d.getElementById("ledwarning").style.display=r>maxPB||u>800||bquot>80?"inline":"none",d.getElementById("ledwarning").style.color=r>maxPB||u>maxPB||bquot>100?"red":"orange",d.getElementById("wreason").innerHTML=bquot>80?"80% of max. LED memory"+(bquot>100?` (<b>WARNING: Using over ${maxM}B!</b>)`:""):"800 LEDs per pin";var L=Math.ceil((100+r*laprev)/500)/2;L=L>5?Math.ceil(L):L;a="";var f=30==d.Sf.LAsel.value,E=255==d.Sf.LAsel.value;L<1.02&&!f&&!E?a="ESP 5V pin with 1A USB supply":(a+=f?"12V ":E?"WS2815 12V ":"5V ",a+=L,a+="A supply connected to LEDs");var I=Math.ceil((100+r*laprev)/1500)/2,b="(for most effects, ~";b+=I=I>5?Math.ceil(I):I,b+="A is enough)<br>",d.getElementById("psu").innerHTML=a,d.getElementById("psu2").innerHTML=E?"":b}function lastEnd(e){return e<1?0:(v=parseInt(d.getElementsByName("LS"+(e-1))[0].value)+parseInt(d.getElementsByName("LC"+(e-1))[0].value),isNaN(v)?0:v)}function addLEDs(e){if(e>1)return maxB=e,void(d.getElementById("+").style.display="inline");var n=d.getElementsByClassName("iST"),t=n.length;if(!(1==e&&t>=maxB||-1==e&&0==t)){var a=d.getElementById("mLC");if(1==e){var l=`<div class="iST">\n${t>0?'<hr style="width:260px">':""}\n${t+1}:\n<select name="LT${t}" onchange="UI(true)">\n<option value="22">WS281x</option>\n<option value="30">SK6812 RGBW</option>\n<option value="31">TM1814</option>\n<option value="24">400kHz</option>\n<option value="50">WS2801</option>\n<option value="51">APA102</option>\n<option value="52">LPD8806</option>\n<option value="53">P9813</option>\n<option value="41">PWM White</option>\n<option value="42">PWM WWCW</option>\n<option value="43">PWM RGB</option>\n<option value="44">PWM RGBW</option>\n<option value="45">PWM RGBWC</option>\n</select>&nbsp;\nColor Order:\n<select name="CO${t}">\n<option value="0">GRB</option>\n<option value="1">RGB</option>\n<option value="2">BRG</option>\n<option value="3">RBG</option>\n<option value="4">BGR</option>\n<option value="5">GBR</option>\n</select><br>\n<span id="p0d${t}">Pin:</span> <input type="number" name="L0${t}" min="0" max="40" required style="width:35px" onchange="UI()"/>\n<span id="p1d${t}">Clock:</span> <input type="number" name="L1${t}" min="0" max="40" style="width:35px" onchange="UI()"/>\n<span id="p2d${t}"></span><input type="number" name="L2${t}" min="0" max="40" style="width:35px" onchange="UI()"/>\n<span id="p3d${t}"></span><input type="number" name="L3${t}" min="0" max="40" style="width:35px" onchange="UI()"/>\n<span id="p4d${t}"></span><input type="number" name="L4${t}" min="0" max="40" style="width:35px" onchange="UI()"/>\n<br>\n<span id="psd${t}">Start:</span> <input type="number" name="LS${t}" id="ls${t}" min="0" max="8191" value="${lastEnd(t)}" required />&nbsp;\n<div id="dig${t}" style="display:inline">\nCount: <input type="number" name="LC${t}" min="0" max="${maxPB}" value="1" required oninput="UI()" /><br>\nReverse (rotated 180°): <input type="checkbox" name="CV${t}">\n</div>\n&nbsp;RGBW: <input id="ew${t}" type="checkbox" name="EW${t}"><br>\n</div>`;a.insertAdjacentHTML("beforeend",l)}-1==e&&(n[--t].remove(),--t),d.getElementById("+").style.display=t<maxB-1?"inline":"none",d.getElementById("-").style.display=t>0?"inline":"none",UI()}}function tglFld(e){var n=d.getElementsByName(e.id.substring(1))[0];n.readOnly=!e.checked,n.value=e.checked?"":"-1"}function GetV() {var d=document;
...
onclick="B()">Back</button><button type="button" onclick="trySubmit()">Save
</button><hr></div><h2>LED &amp; Hardware setup</h2>Total LED count: <input 
name="LC" id="LC" type="number" min="1" max="8192" oninput="UI()" required 
...
style="width:260px">Relay pin: <input type="checkbox" id="cRL" 
onchange="tglFld(this)"> <input type="number" min="-1" max="40" name="RL" 
onchange="UI()"> Active high <input type="checkbox" name="RM"><br>Button pin: 
<input type="checkbox" id="cBT" onchange="tglFld(this)"> <input type="number" 
min="-1" max="40" name="BT" onchange="UI()"><br>IR pin: <input type="checkbox" 
id="cIR" onchange="tglFld(this)"> <input type="number" min="-1" max="40" 
name="IR" onchange="UI()"><br>AUX pin: <input type="checkbox" id="cAX" 
onchange="tglFld(this)"> <input type="number" min="-1" max="40" name="AX" 
onchange="UI()"><h3>Defaults</h3>Turn LEDs on after power up/reset: <input 
...
</select><br>Skip first LED: <input type="checkbox" name="SL"><br><span 
...
</button><button type="button" onclick="trySubmit()">Save</button></form></body>
</html>)=====";
