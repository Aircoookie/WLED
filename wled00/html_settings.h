...
max="40" name="IR" onchange="UI()" style="width:40px"><select name="IT" 
...
onchange="UI()" style="width:40px"> invert <input type="checkbox" name="RM">
