...
name="0A" type="number" min="0" max="255"> . <input name="0B" 
type="number" min="0" max="255"> . <input name="0C" type="number" 
min="0" max="255"> . <input name="0D" type="number" 
min="0" max="255"><br><input name="1A" type="number" min="0" 
max="255"> . <input name="1B" type="number" min="0" 
max="255"> . <input name="1C" type="number" min="0" 
max="255"> . <input name="1D" type="number" min="0" max="255"><br>
<input name="2A" type="number" min="0" max="255"> . <input name="2B"
 type="number" min="0" max="255"> . <input name="2C" type="number" 
min="0" max="255"> . <input name="2D" type="number" 
min="0" max="255"><br><input name="3A" type="number" min="0" 
max="255"> . <input name="3B" type="number" min="0" 
max="255"> . <input name="3C" type="number" min="0" 
max="255"> . <input name="3D" type="number" min="0" max="255"><br>
<input name="4A" type="number" min="0" max="255"> . <input name="4B"
 type="number" min="0" max="255"> . <input name="4C" type="number" 
min="0" max="255"> . <input name="4D" type="number" 
min="0" max="255"><br><input name="5A" type="number" min="0" 
max="255"> . <input name="5B" type="number" min="0" 
max="255"> . <input name="5C" type="number" min="0" 
max="255"> . <input name="5D" type="number" min="0" max="255"><br>
<input name="6A" type="number" min="0" max="255"> . <input name="6B"
 type="number" min="0" max="255"> . <input name="6C" type="number" 
min="0" max="255"> . <input name="6D" type="number" 
min="0" max="255"><br><input name="7A" type="number" min="0" 
max="255"> . <input name="7B" type="number" min="0" 
max="255"> . <input name="7C" type="number" min="0" 
max="255"> . <input name="7D" type="number" min="0" max="255"><br>
<input name="8A" type="number" min="0" max="255"> . <input name="8B"
 type="number" min="0" max="255"> . <input name="8C" type="number" 
min="0" max="255"> . <input name="8D" type="number" 
min="0" max="255"><br><input name="9A" type="number" min="0" 
max="255"> . <input name="9B" type="number" min="0" 
max="255"> . <input name="9C" type="number" min="0" 
max="255"> . <input name="9D" type="number" min="0" max="255"><br>
