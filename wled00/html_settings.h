...
<button type="submit">Save</button><hr><h2>LED &amp; HW setup</h2>
Total LED count: <input name="LC" type="number" min="1" max="1500" 
oninput="UI()" required><br>LED strips <button type="button" id="+" 
...
Loading...</div><hr>Relay pin: <input type="number" min="-1" max="40" name="RL" 
