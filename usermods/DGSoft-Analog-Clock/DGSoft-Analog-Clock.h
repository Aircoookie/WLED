...
class DGSAnalogClockUsermod : public Usermod
{
...
public:
  ...
  void handleOverlayDraw()
  {
    ...
    if (!analogClockSecondsTrail)
      strip.setPixelColor(secondPixel, 0xFF0000);
  ...
  uint16_t getId()
  {
    return USERMOD_ID_DGS_ANALOG_CLOCK;
  }
...
const char DGSAnalogClockUsermod::_name[] PROGMEM = "DGS Analog Clock";
const char DGSAnalogClockUsermod::_enabled[] PROGMEM = "enabled";

// implementation of non-inline member methods

void DGSAnalogClockUsermod::publishMqtt(const char *state, bool retain)
{
#ifndef WLED_DISABLE_MQTT
