...
#else
            3592 + 1024,                      // When debugging, the DEBUG_PRINT statements increase the stack usage.
                                              // The stack space exception / crashes can mask the debug message of what failed.
                                              // Just adding a little more stack space to avoid out of stack exceptions. 
                                              // This size can be debugging dependent.  If you hit the stack space exception
                                              // increase the size. 
#endif
