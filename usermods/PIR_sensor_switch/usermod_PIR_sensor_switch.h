...
*/
  ...
  {
    oappend(SET_F("addInfo('PIRsensorSwitch:help',0,'<button onclick=\"location.href=&quot;https://kno.wled.ge/usermods/PIRsensorSwitch&quot;\" type=\"button\">?</button>');"));  // 0 is field type, 1 is actual field
