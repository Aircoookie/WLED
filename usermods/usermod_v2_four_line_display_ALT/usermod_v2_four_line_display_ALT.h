...
*/
    ...
    void appendConfigData() {
      oappend(SET_F("addInfo('4LineDisplay:help',0,'<button onclick=\"location.href=&quot;https://kno.wled.ge/usermods/4LineDisplay&quot;\" type=\"button\">?</button>');"));  // 0 is field type, 1 is actual field
