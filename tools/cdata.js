...
function ledClockPostProcessHtml(html) {
  return html.replace(/<link\s+rel\s*=\s*"icon"\s+href\s*=\s*"[^"]+"\s*\/?>/gm, '<link rel="icon" href="favicon.svg"/>');
}
...
function writeHtmlGzipped(sourceFile, resultFile) {
  ...
  new inliner(sourceFile, function (error, html) {
    ...
    html = ledClockPostProcessHtml(html);
